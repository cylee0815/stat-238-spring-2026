...
\ImportTok{from}\NormalTok{ scipy.stats }\ImportTok{import}\NormalTok{ beta, gamma, binom}
...
\NormalTok{log\_likelihood }\OperatorTok{=}\NormalTok{ binom.logpmf(x\_obs, n, theta\_grid)}
